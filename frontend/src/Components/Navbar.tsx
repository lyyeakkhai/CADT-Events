...
export default function Navbar({
  ...
  return (
    <header className="w-full bg-[#f8fafc] border-b border-slate-200/80 sticky top-0 z-50 backdrop-blur-md bg-white/95">
      {/* CRITICAL CHANGE: Changed 'justify-between' to direct layout flex.
        Removed max-w-7xl constraint to let the elements stretch neatly to the screen edges.
      */}
      <div className="w-full px-4 sm:px-8 lg:px-12 h-16 flex items-center">
        
        {/* =======================================================================
            SECTION 1: BRAND LOGO (Left Column - Snapped left via justify-start)
           ======================================================================= */}
        <div className="flex-1 flex items-center justify-start">
          ...
          >
            <div className="w-7 h-7 flex items-center justify-center bg-blue-900 text-white text-xs font-black transition-transform duration-200 group-hover:scale-105 shadow-sm rounded-lg overflow-hidden">
              <img src={Logo} alt="Logo" className="w-full h-full object-contain" />
            </div>

            <span className="text-[15px] font-black text-blue-900 tracking-tight">
              CADT Event
            </span>
          </div>
        </div>
        ...
        {/* =======================================================================
            SECTION 2: CENTER NAVIGATION (Middle Column - Isolated and centered perfectly)
           ======================================================================= */}
        <div className="hidden md:flex flex-initial items-center justify-center h-full">
          <nav className="flex items-center gap-8 h-full text-[14px] font-medium text-slate-500">
            {navItems.map((item) => {
        ...
        {/* =======================================================================
            SECTION 3: ACTIONS & PROFILE (Right Column - Snapped right via justify-end)
           ======================================================================= */}
