...
export default function Register({ onBackClick, onInstituteLoginClick, onExternalSubmitComplete }: RegisterProps) {
  // Input fields state tracking logic
    ...
    <div className="min-h-screen w-full bg-[#f0f4f9] flex flex-col justify-between font-sans antialiased selection:bg-blue-100">
      ...
      <main className="flex-grow flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-4xl bg-white rounded-3xl shadow-xl border border-slate-200/80 overflow-hidden grid grid-cols-1 md:grid-cols-12 items-stretch animate-fade-in">
          ...
          {/* =======================================================================
              LEFT BLUE PANEL: STUDENT/STAFF INSTITUTIONAL CREDENTIALS PORTAL
             ======================================================================= */}
          <div className="md:col-span-5 bg-[#030712] p-8 sm:p-10 text-white flex flex-col justify-between border-b md:border-b-0 md:border-r border-slate-800">
            <div className="space-y-4">
              ...
              <p className="text-xs font-medium text-slate-400 leading-relaxed">
                Are you an active student, researcher, or staff member of the CADT community? Use your institutional credentials for secure, instant access. 
              </p>
              
              {/* Official OAuth Integration Button Accent */}
              <button 
          ...
          {/* =======================================================================
              RIGHT WHITE PANEL: EXTERNAL PARTICIPANT ACCOUNT SIGNUP FORM
             ======================================================================= */}
          <form onSubmit={handleSubmit} className="md:col-span-7 p-8 sm:p-10 space-y-5 bg-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2.5 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:bg-white transition-all"
                />
              </div>
            ...
            {/* Checkbox confirmation validation block */}
      ...
      {/* Embedded Mini-Tray Information Hub Footer */}
      <footer className="w-full text-center py-4 bg-[#090d16] text-[11px] font-bold text-slate-500 border-t border-slate-900">
        Already have an institutional account? <span onClick={onInstituteLoginClick} className="text-blue-400 underline cursor-pointer hover:text-blue-300 pl-1">log in</span> 
      </footer>
